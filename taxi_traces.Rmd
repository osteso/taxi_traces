...
The package sf is quite powerful. In addition to linestrings, we can also use points and polygons and a variety of functions to investigate relative properties of geoemetries. For example, we can divide Beijing in its districs and investigate where the taxis travel the most. 

To do this, we first need the boundaries of the districts. Following the guidelines of Florian Zenoni's blog post of the 10/10/2017, we get this information from the OpenStreetMaps API, using the package osmdata:
